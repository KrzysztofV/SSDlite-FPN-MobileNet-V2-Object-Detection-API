...
class ConvolutionalBoxHead(head.Head):
  ...
  def predict(self, features, num_predictions_per_location):
    ...
    if self._use_depthwise:
      ...
      box_encodings_resizer_3x3 = slim.separable_conv2d(
          net, None, [self._kernel_size, self._kernel_size],
          padding='SAME', depth_multiplier=1, stride=2,
          rate=1, scope='BoxEncodingPredictor_depthwise')
      box_encodings_resizer_1x1 = slim.conv2d(
          box_encodings_resizer_3x3,
          256, [1, 1],
          activation_fn=None,
          normalizer_fn=None,
      ...
      box_encodings = slim.separable_conv2d(
          box_encodings_resizer_1x1, None, [self._kernel_size, self._kernel_size],
          padding='SAME', depth_multiplier=1, stride=1,
          rate=1, scope='BoxEncodingPredictor_depthwise_2')
