...
class ConvolutionalClassHead(head.Head):
  ...
  def predict(self, features, num_predictions_per_location):
    ...
    if self._use_depthwise:
        ...
        # Dodatkowy blok z konwolucją depthwise i pointwise
      class_predictions_resizer_3x3 = slim.separable_conv2d(
          net, None, [self._kernel_size, self._kernel_size],
          padding='SAME', depth_multiplier=1, stride=2,
          rate=1, scope='ClassPredictor_depthwise')
      class_predictions_resizer_1x1 = slim.conv2d(
          class_predictions_resizer_3x3,
          256, [1, 1],
          activation_fn=None,
          normalizer_fn=None,
          normalizer_params=None,
          scope='ClassPredictor_pointhwise')
      class_predictions_with_background = slim.separable_conv2d(
          class_predictions_resizer_1x1, None, [self._kernel_size, self._kernel_size],
          padding='SAME', depth_multiplier=1, stride=1,
          rate=1, scope='ClassPredictor_depthwise_2')
      class_predictions_with_background = slim.conv2d(
          ...
          normalizer_fn=None,
          normalizer_params=None,
          scope='ClassPredictor_pointhwise_2')
